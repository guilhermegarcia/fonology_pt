...
- Atualmente em desenvolvimento (v. 0.5.1); atualizações frequentes

- **Hoje**: demo das principais funções com exemplos reais
...
- **Nota**: A função usa 17 níveis de sonoridade (ver Parker 2011)
...
- Vamos criar uma tabela com 8 palavras novas + probabilidade fonotática com `biGram_pt()`:
